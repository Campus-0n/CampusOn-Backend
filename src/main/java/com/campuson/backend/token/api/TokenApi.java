package com.campuson.backend.token.api;

import com.campuson.backend.global.config.swagger.*;
...
public interface TokenApi {
    ...
    @SwaggerApiResponses(
            ...
            errors = { @SwaggerApiFailedResponse(ExceptionType.JWT_INVALID) }
    )
    @PostMapping("/logout")
    ResponseEntity<ResponseBody<Void>> logout(Authentication authentication);
